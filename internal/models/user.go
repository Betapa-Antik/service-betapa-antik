...
type User struct {
	...
	NoPegawai   string     `gorm:"type:varchar(50);uniqueIndex;not null" json:"no_pegawai"`
	...
	RoleID      *uuid.UUID `gorm:"type:uuid;nullable;foreignKey:RoleID;references:ID" json:"role_id"`
